...
export function buildSystemPrompt(brandContext: string, skills: LoadedSkill[] | string, extraContext?: string): string {
...
export function buildTaskPrompt(taskContext: string, userInput: string): string {
  const parts: string[] = [];

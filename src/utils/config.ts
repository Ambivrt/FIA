...
const configSchema = z.object({
  ...
  workvivoApiKey: z.string().default(""),
  workvivoBaseUrl: z.string().default("https://api.workvivo.com/v2"),
...
export function loadConfig(): AppConfig {
  ...
  const raw = {
    ...
    workvivoApiKey: process.env.WORKVIVO_API_KEY || "",
    workvivoBaseUrl: process.env.WORKVIVO_BASE_URL || "https://api.workvivo.com/v2",

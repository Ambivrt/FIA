...
Godkännandekön är en av dina viktigaste arbetsytor. Här granskar du innehåll som agenterna har producerat innan det publiceras eller levereras.

---

## Vad hamnar i godkännandekön?

Uppgifter med status **awaiting_review** visas i kön. Det gäller framför allt:

- Bloggartiklar och långformat innehåll
- Inlägg för sociala medier
- Email-sekvenser och kampanjtexter
...
## Tre alternativ vid granskning

När du granskat innehållet har du tre val:

### Godkänn

Innehållet är bra och redo att publiceras eller levereras. Uppgiften går vidare i flödet.
...
Innehållet har potential men behöver justeras. Uppgiften skickas tillbaka till agenten med din feedback för omarbetning. Den dyker upp i kön igen när agenten är klar.

---

## Brand Agents roll

Innan innehåll når din godkännandekö har det redan granskats automatiskt av **Brand Agent**. Brand Agent kontrollerar:

- Att tonen stämmer med Forefronts varumärkesröst
- Att texten följer riktlinjerna för språk och stil
- Att inga varumärkeskänsliga formuleringar används
...
!!! danger "Eskalering efter tre avslag"
    ...
    3. Alternativt godkänna innehållet om du bedömer att Brand Agents invändning inte är relevant.

---

## Vad händer efter godkännande?

När du godkänner en uppgift händer följande:

1. Uppgiftens status ändras till **delivered** eller **activated**.
2. Innehållet publiceras eller skickas via rätt kanal (blogg, sociala medier, email).
3. Eventuella **nedströms-uppgifter** kan skapas automatiskt -- till exempel att SEO Agent optimerar en publicerad bloggpost.
